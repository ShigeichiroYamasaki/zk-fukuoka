...
三幕を横断して、関心のあるトピックから関連する授業を探せます。第1〜5回のリンク先は講義本文、それ以外は現在のシラバス案です。第6〜15回の本編教材は準備中です。

[各回の授業から探す](./sessions) · [シラバス全体を読む](./)

- [証明の基礎・安全性定義](#proofs)
- [有限体・多項式・算術化](#algebra)
- [計算量理論・PCP・IOP](#complexity)
- [誤り訂正符号・情報理論](#coding)
- [FRI・健全性評価](#fri)
- [楕円曲線・ペアリング・困難性仮定](#curves)
- [コミットメント・非対話化](#commitments)
...
| トピック | 関連する授業 |
| --- | --- |
| Cook–Levin・Circuit-SAT・NC・P | [第4回](./session-04) |
| PCP定理・近似困難性 | [第10回](./#session-10) |
| IOP・確率的検査 | [第3回](./session-03) / [第10回](./#session-10) |
| 計算量理論的結果とプロトコルの対応 | [第14回](./#session-14) |

## 誤り訂正符号・情報理論 {#coding}

| トピック | 関連する授業 |
| --- | --- |
| Reed–Solomon・最小距離・誤り訂正能力 | [第5回](./session-05) |
| Shannon限界・Hamming限界・list decoding | [第5回](./session-05) |

## FRI・健全性評価 {#fri}

| トピック | 関連する授業 |
| --- | --- |
| Low-Degree Testing・FRI・再帰的折り畳み | [第6回](./#session-6) |
| 健全性増幅・健全性誤差 | [第5回](./session-05) / [第6回](./#session-6) |
| Rewinding・forking lemma | [第6回](./#session-6) |
| FRIベースのコミットメント・STARKへの統合 | [第8回](./#session-8) / [第13回](./#session-13) |

## 楕円曲線・ペアリング・困難性仮定 {#curves}

| トピック | 関連する授業 |
| --- | --- |
| 楕円曲線群・双線形ペアリング | [第7回](./#session-7) |
| BN254・BLS12-381 | [第7回](./#session-7) |
| Discrete Log・q-SDH・還元証明 | [第7回](./#session-7) |
| 標準仮定・非標準仮定・プロトコルとの対応 | [第7回](./#session-7) / [第14回](./#session-14) |
