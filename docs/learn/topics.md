...
三幕を横断して、関心のあるトピックから関連する授業を探せます。第1〜9回のリンク先は講義本文、それ以外は現在のシラバス案です。第10〜15回の本編教材は準備中です。
...
| トピック | 関連する授業 |
| --- | --- |
| 楕円曲線群・双線形ペアリング | [第7回](./session-07) |
| BN254・BLS12-381 | [第7回](./session-07) |
| Discrete Log・q-SDH・還元証明 | [第7回](./session-07) |
| 標準仮定・非標準仮定・プロトコルとの対応 | [第7回](./session-07) / [第14回](./#session-14) |

## コミットメント・非対話化 {#commitments}

| トピック | 関連する授業 |
| --- | --- |
| 多項式コミットメント・KZG | [第8回](./session-08) |
| Binding・hiding | [第8回](./session-08) |
| Fiat–Shamir変換 | [第2回](./session-02) / [第9回](./session-09) |
| Random Oracle Model・安全性証明と限界 | [第9回](./session-09) |
